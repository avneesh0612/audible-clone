      ...
      >
        ...
        <div className="relative flex w-screen h-full md:h-[52vh]">
          ...
          >
            ...
            <div className="w-80 ml-9">
              <button className=" transition duration-500 ease-in-out bg-[#FFA000] hover:bg-[#FFC849] py-2  transform hover:-translate-y-1 hover:scale-110 rounded-md mt-10 w-full">
                Start your free trial now
              </button>
              <p className="text-white text-opacity-60 text-xs text-center">
                ₹199 per month after 30-day trial. Cancel anytime.
